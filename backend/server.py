...
async def analyze_period(
    ...
    try:
        ...
        try:
            ...
            3. В разделе 4 выведи два списка: «Новые клиенты» и «Новые продукты». 
            4. Для новых источников всегда пиши формат: (Было: $0 → Стало: $X).
            5. Стиль: сухой, плотный, информативный. Минимум вводных слов.

            ПРИМЕР ИДЕАЛЬНОГО ОТВЕТА:
            📊 1. Общая динамика и характер тренда
            Выручка выросла на 15%, тренд системный. Основной рост пришелся на вторую неделю месяца.

            🏢 2. Поведение ключевых клиентов
            - Client A: рост на $50k (продукт X).
            - Client B: снижение на $10k из-за сезонности.
