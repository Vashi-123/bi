      ...
      <div className="fixed inset-0 z-[1000] bg-[#0C0C0C] flex flex-col items-center justify-center overflow-hidden font-sans">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6">
          ...
          <h1 className="text-3xl md:text-5xl font-black text-white mb-4 tracking-tighter uppercase italic">
            Sales Engine <span className="text-[#DDFF55]">Initializing</span>
          </h1>
          <div className="flex items-center gap-3 justify-center mb-8">
             <div className="w-2 h-2 bg-[#DDFF55] rounded-full animate-ping" />
             <p className="text-slate-400 font-bold uppercase tracking-[0.3em] text-[10px]">
                Synchronizing Sales Datasets
             </p>
          </div>
    ...
    <div className="min-h-screen text-[#0C0C0C] font-sans selection:bg-blue-100 selection:text-blue-900 bg-[#F8FAFC]">
      ...
      <nav className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-slate-100 px-8 py-4 flex justify-between items-center shadow-sm">
        <Flex className="gap-6 w-auto cursor-pointer" justifyContent="start">
          <Link href="/sales" className="text-xl font-black text-[#0C0C0C] tracking-tighter uppercase italic">Sales <span className="text-[#DDFF55]">Hub</span></Link>
          <div className="h-6 w-[1px] bg-slate-200" />
          <Link href="/purchase" className="text-sm font-bold text-slate-400 hover:text-slate-600 uppercase tracking-widest">Purchases</Link>
        </Flex>
      ...
      <main className="relative z-10 max-w-[1600px] mx-auto p-10 space-y-12 pb-24">
        <div className="flex justify-between items-end">
            <div>
                <h1 className="text-4xl font-black text-[#0C0C0C] tracking-tight uppercase italic">Sales <span className="text-[#DDFF55]">Analytics</span></h1>
                <p className="text-slate-400 text-sm font-medium">Real-time revenue and profit distribution overview</p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <KPICard title="Revenue" period={kpiData?.meta.current_period} baselinePeriod={kpiData?.meta.prev_period} value={kpiData?.revenue.value} baseline={kpiData?.revenue.prev} growth={kpiData?.revenue.growth} active={activeMetric === 'revenue'} onClick={() => setActiveMetric('revenue')} isCurrency={true} hasComparison={canCompare} />
            <KPICard title="Profit" period={kpiData?.meta.current_period} baselinePeriod={kpiData?.meta.prev_period} value={kpiData?.profit.value} baseline={kpiData?.profit.prev} growth={kpiData?.profit.growth} active={activeMetric === 'profit'} onClick={() => setActiveMetric('profit')} isCurrency={true} hasComparison={canCompare} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="rounded-3xl p-8 bg-white h-[500px] flex flex-col shadow-xl shadow-slate-200/50">
                <Title className="text-xl font-bold mb-6">Leaderboard</Title>
            ...
            <Card className="rounded-3xl p-8 bg-white h-[500px] flex flex-col shadow-xl shadow-slate-200/50">
                <Title className="text-xl font-bold mb-6">Market Share</Title>
            ...
            <Table>
                <TableHead>
                    <TableRow>
                        ...
                        <TableHeaderCell className="text-right text-[10px] font-bold uppercase tracking-widest">Revenue</TableHeaderCell>
