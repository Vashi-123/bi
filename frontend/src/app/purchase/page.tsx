    ...
    <div className="min-h-screen text-[#0C0C0C] font-sans selection:bg-blue-100 selection:text-blue-900 bg-[#F8FAFC]">
      ...
      <main className="relative z-10 max-w-[1600px] mx-auto p-10 space-y-12 pb-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <KPICard title="Stock Value" period={kpiData?.meta.current_period} baselinePeriod={kpiData?.meta.prev_period} value={kpiData?.stock.value} baseline={kpiData?.stock.prev} growth={kpiData?.stock.growth} active={activeMetric === 'stock'} onClick={() => setActiveMetric('stock')} isCurrency={true} hasComparison={false} />
